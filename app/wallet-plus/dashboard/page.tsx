                ...
                <div key={item.id} className="bg-gray-900 p-5 rounded">
                  ...
                  {progress >= 100 && (
                    <p className="text-xs text-green-400 mt-2">
                      ✅ Target reached. Withdrawal can be enabled subject to
                      platform approval.
                    </p>
                  )}
                </div>
      ...
      <section className="max-w-5xl mx-auto mb-8">
        ...
        {activeAdvance && (
          <div className="bg-yellow-950 border border-yellow-700 p-4 rounded mb-4 text-sm">
            ⚠️ You currently have an active or pending advance request. You must
            settle the current request before making another one.
          </div>
        )}
              ...
              <div key={item.id} className="bg-gray-900 p-5 rounded">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">
                      Supporters: {item.supporter_one || 'N/A'} and{' '}
                      {item.supporter_two || 'N/A'}
                    </p>
                  </div>
